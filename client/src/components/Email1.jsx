      ...
      <div className="body">
        ...
        <div className="body1">
          ...
          <div className="body2">
            ...
            {/* Nouveau code pour le bouton de téléchargement */}
            <div className="mailcontent-container">
  <p className="mailcontent">{emailData.message}</p>
...
.attachment-container {
  ...
  .download-button:hover {
    background-color: transparent;
    color : #395886 ;  }
    /* Styles CSS pour le bouton de téléchargement */
    .download-button {
      background-color: #395886;
      color: white;
      border: none;
    ...
    .button-text {
        flex-grow: 1; /* Fait en sorte que le texte "Download" occupe tout l'espace disponible */
        white-space: nowrap; /* Empêche le texte de passer à la ligne */
        overflow: hidden; /* Cache le texte dépassant de la boîte */
        text-overflow: ellipsis; /* Affiche des points de suspension (...) pour indiquer du texte coupé */
        margin-right: 5px; /* Marge à droite pour séparer le texte du nom du fichier */
      }
    
      .file-name {
        color: #ccc;
        margin-left: 8px; /* Ajoutez une marge à gauche pour l'espace */
        max-width: 150px; /* Limitez la largeur du conteneur du nom du fichier */
        overflow: hidden;
